...
public class RulesOf6005 {
    ...
    public static boolean mayUseCodeInAssignment(boolean writtenByYourself,
    	...
    	//Code is allowed if the person wrote it themselves
        if(writtenByYourself) {
        	return true;
        }
        //if the code was not written by you, certain other rules apply
        //if it has been used by other students in coursework, it is not allowed
        if(writtenAsCourseWork) {
        	return false;
        }
        else {
        	//if it is readily available to everyone, is cited properly and your own implementation is not required, it can be used
